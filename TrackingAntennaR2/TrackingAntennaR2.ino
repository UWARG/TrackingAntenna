...
//int pos = 0;    //Servo position variable, currently unused 


void SetPan(int ThetaXY)	//Pan is horizontal
{
	//
	if(servoPanLastWrite + 15 > millis())    //give the servo time to move without stopping the entire program
	//{
	servoPan.writeMicroseconds(SERVO_MIDPOINT - ThetaXY * DEGREE_TO_PWM);	//GEAR_RATIO_XY?
	//servoPanLastWrite = millis();
	//}
}


void SetTilt(int ThetaYZ)	//Tilt is vertical
{    
